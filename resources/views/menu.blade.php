...
<body style="background-color: rgb(255, 248, 248) ; width: %100; overflow:-moz-scrollbars-vertical; overflow-x:hidden; overflow:-moz-scrollbars-vertical; overflow;" >
    <div class="container" style="background-color: rgb(235, 233, 233);width: %100;">
      <div class="row" style="background-color: rgb(235, 233, 233); width: %100;">
        ...
        İndirimli ürünleri incelemek için <a href="i">tıklayın</a>
        </div>
        <div class="col">
          <ul>
            <a href="anasayfa" style="text-decoration: none; color:rgb(71, 56, 2); vertical-align: middle; position: absolute; top: 10px; right: 650px;" >Anasayfa</a>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          ...
          <td  >Hoşgeldin {{session('LoggedUserName')}} {{session('LoggedUserLast')}}</td>
       
          
         <a href='i?logout=true'> <button style=" position: absolute; top: 2px; right: 120px; height: 35px; width: 100px;" type="submit" class="btn btn-danger" >Çıkış Yap</button></a>
